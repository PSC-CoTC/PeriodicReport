...
plotly::ggplotly(psc_gg$ann_abund)
...
## Abundance series (bar escp+hvst)
...
plotly::ggplotly(psc_gg$ann_escp_hvst)
...
plotly::ggplotly(psc_gg$er_fishery)  
```

## NS vs MSF for a few stocks {.tabset}
