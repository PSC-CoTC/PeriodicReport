...
plot_pre_v_post <- function(stknm="Skagit", fishery_id_pre=15, fishery_id_post=16){
...
The Thompson River is the largest tributary of the Fraser River and it contains three of the five CUs in the Interior Fraser River {{< glossary MU >}}. The Thompson River basin drains 56,000 km2 (22,000 mi2) with an average flow in the main stem (measured near Spences Bridge before Lytton) of 773 m3/s (27,300 cu ft/s). The two major tributaries of the Thompson River, the North and South Thompson rivers, join at the city of Kamloops. The North Thompson originates at the Thompson Glacier near Valemount. The South Thompson River originates from Little Shuswap Lake but there are serval major Coho Salmon spawning systems (e.g., Adams River, Shuswap River, etc) that drain into Shuswap Lake that is connected to Little Shuswap Lake by the Little River.
...
ToDo: check the MU descriptions to see if I mistakenly placed this here!!!!  It describes the LWFR and not IFR!
...
| **Status(PSC/{{< glossary Council display = PFMC >}})**  | **Ocean Abundance** </br> **Reference Breakpoint**  |**Total Exploitation Rate** |
|:--------------------------|:--------------------------------------:|:-----------------------:|
...
#| tbl-cap: Historical summary of annual total abundance (January age-3 without natural mortality), adult escapement, marine survival (Baker River Wild), and {{< glossary ER >}} (ER) of the Skagit Management Unit; since 2004. 
...
plot_pre_v_post("Stillaguamish", 17, 17)
...
#| tbl-cap: Historical summary of annual total abundance (January age-3 without natural mortality), adult escapement, marine survival (Skykomish), and {{< glossary ER >}} (ER) of the Stillaguamish Management Unit; since 2004. 
...
All wild Coho Salmon that originate from the Snohomish basin constitute a single {{< glossary MU >}} and are managed as a single stock.  Snohomish River Coho Salmon belong to the larger Puget Sound/Strait of Georgia Coho Salmon evolutionarily significant unit (ESU; Weitkamp et al. 1995).  This ESU is currently a species of concern under the US Endangered Species Act (NOAA Fisheries 2009).

#### Management Framework
##### Management Objectives
Under the Comprehensive Coho Salmon Management Plan (CCW 1998), Snohomish River wild Coho Salmon is the primary (key) {{< glossary MU >}} and hatchery production is an auxiliary {{< glossary MU >}} (CCW 1998).  Under this plan, primary {{< glossary MUs >}} are controlling units in the sense that predefined management actions that will be undertaken under specified abundance conditions, auxiliary {{< glossary MUs >}} are those managed to meet or exceed a minimum escapement, and secondary units are passively managed in mixed stock fisheries.  Therefore, Snohomish River Coho Salmon are managed for natural (wild) production.  

Snohomish Coho Salmon are a primary {{< glossary MU >}} for Puget Sound under the {{< glossary Council display = PFMC >}} (PFMC 2011).  Other primary {{< glossary MUs >}} in this region are eastern Strait of Juan de Fuca, Hood Canal, Skagit, Stillaguamish, and South Puget Sound (hatchery) Coho Salmon (PFMC 2011).  The {{< glossary Council display = PFMC >}}’s conservation objectives for these {{< glossary MUs >}} are based on the Puget Sound Salmon Management Plan, which includes management objectives and long-term goals for these stocks as developed by representatives from federal, state, and tribal agencies. 
...
**Current Snohomish {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by {{< glossary PSC >}} and {{< glossary Council display = PFMC >}} status categories.**
...
##### Stock Assessment
Since 1996, WDFW and tribal biologists have developed forecasts of wild Coho Salmon run size for all primary and most secondary {{< glossary MUs >}} in Puget Sound and the Washington coast (Seiler 1996, Zimmerman 2011).  These annual forecasts are described in the {{< glossary Council display = PFMC >}}’s Preseason Forecast I document each February (PFMC 2012; www.pcouncil.org).  These forecasts rely on estimates of wild Coho Salmon production (i.e., smolts) paired with estimates of marine survival.  Wild Coho Salmon production estimates for each of the primary and secondary {{< glossary MUs >}} in Puget Sound were derived from results of juvenile trapping studies conducted in the Skagit, Stillaguamish, Snohomish, Green, Nisqually, and Deschutes rivers as well as in tributaries to Lake Washington and Hood Canal.  Analysis of these long-term data sets have demonstrated that wild Coho Salmon smolt production is limited by a combination of factors including seeding levels (i.e., escapement), environmental effects (flows, marine derived nutrients), and habitat degradation (Zimmerman 2012). 
...
A number of salmon hatchery facilities exist within the Hood Canal {{< glossary MU >}} and listed below are the Coho Salmon programs in the canal (\@ref(fig:Hood_Canal_MU).
...
**Current Hood Canal {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by {{< glossary PSC >}} and {{< glossary Council display = PFMC >}} status categories.**
...
**Total number of Hood Canal wild Coho Salmon tagged and released, brood years 1983-2020 (data downloaded on ??; [@RMISD_1977])
...
**Current US Strait JDF {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ER >}} by {{< glossary PSC >}} and {{< glossary Council display = PFMC >}} status categories.**


| **Status(PSC/{{< glossary Council display = PFMC >}})**  | **Ocean Abundance** </br> **Breakpoint**  |**Total Exploitation Rate** |
|:--------------------------|:--------------------------------------:|:-----------------------:|
...
Hatchery production within this {{< glossary MU >}} has averaged 1.3 million Coho Salmon released annually over broods 1983 through 2020.  Most of this production has been split between the Dungeness (50%) and the Lower Elwha Hatchery (44%). Approximately 673,000 Coho Salmon have been released annually from the Dungeness Hatchery over this period with another 626,000 released annually from the Lower Elwha Hatchery beginning with brood 1985. Mass marking of hatchery fish began with brood 1995 at the Lower Elwha Hatchery and with brood 1996 at the Dungeness Hatchery, averaging 1.1 million annually in total in recent years.
...
**Current Quillayute {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by {{< glossary PSC >}} and {{< glossary Council display = PFMC >}} status categories.**
...
**Current Hoh {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by {{< glossary PSC >}} and {{< glossary Council display = PFMC >}} status categories.**
...
**Queets {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by {{< glossary PSC >}} and {{< glossary Council display = PFMC >}} status categories.**

| **Status(PSC/{{< glossary Council display = PFMC >}})**  | **Ocean Abundance** </br> **Reference Breakpoint**  |**Total Allowable Exploitation Rate** |
|:--------------------------|:--------------------------------------:|:-----------------------:|
...
**Current Grays Harbor {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by {{< glossary PSC >}} and {{< glossary Council display = PFMC >}} status categories.**
