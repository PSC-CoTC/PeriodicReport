...
```{r}
## Historic ER #s
fram_db = connect_fram_db(params$mdb_pst)
...
**Current Stillaguamish {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by {{< glossary PSC >}} and {{< glossary Council display = PFMC >}} status categories.**
...
ToDo: add table or figure of outmigrating smolts
