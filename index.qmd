...
```{r BCAbundance, echo = FALSE, fig.cap = "Estimated Ocean Age-3 Abundances of Southern B.C. Coho Salmon Management Units; Catch Years 1986-2020.", eval=FALSE}
...
Estimates of freshwater production (smolt out-migrants) for hatchery produced Coho, by FRAM production region, are scaled to Base Period production. Next the annual expected regional marine survival (MS) is scaled to Base Period marine survival. Both ratios are applied to a stock’s Base Period Abundance to produce the annual adult abundance forecasts. To illustrate (by stock):
  ...
  (Annual H Smolts) / (Base H Smolts) X (Expected MS) / (Base MS) X Base Adult Abundance = Adult H Abundance
...
* does the SP wish us to describe forecasts for the year we have not assessed post-season?*  
...
The summaries found within this focus on catch years beginning with 2010 through the year with the most recent ER evaluation.  However, some summaries begin with catch year 2004.
