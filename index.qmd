...
The 2023 Stillaguamish natural Ocean Age 3 (OA3) abundance forecast is 30,238, compared to the 2022 preseason forecast of 24,892. This forecast classifies the stock abundance as "Abundant" under the 2019 {{< glossary PST >}}{{< glossary SCMP >}} and “Normal” under the FMP. This results in an allowable total {{< glossary ER >}} of no more than 50% under both the {{< glossary Council >}}-adopted {{< glossary ER >}} matrix and the 2019 {{< glossary PST >}} {{< glossary SCMP >}}.
...
The 2023 Snohomish natural Ocean Age 3 (OA3) abundance forecast is 76,500, compared to the 2022 preseason forecast of 64,200. This forecast classifies the stock abundance as "Moderate" under the 2019 {{< glossary PST >}} {{< glossary SCMP >}} and “Low” under the FMP. This results in an allowable total {{< glossary ER >}} of no more than 40% under both the {{< glossary Council >}}-adopted {{< glossary ER >}} matrix and the 2019 {{< glossary PST >}} {{< glossary SCMP >}}.
...
The 2023 Hood Canal natural OA3 abundance forecast is 37,888, compared to the 2022 preseason forecast of 20,196. This forecast classifies the stock abundance as "Moderate" under the 2019 {{< glossary PST >}} {{< glossary SCMP >}} and “Low” under the FMP. This results in an allowable total {{< glossary ER >}} of no more than 45% under both the {{< glossary Council >}}-adopted {{< glossary ER >}} matrix and the 2019 {{< glossary PST >}} {{< glossary SCMP >}}. 
...
The conservation objectives for the Queets, Hoh, and Quillayute rivers were developed as ranges intended to bracket estimates of MSY escapement. For The Quillayute {{< glossary MU >}}, management objectives are expressed as a range of spawning escapements expected to produce MSY. Allowable {{< glossary ERs >}} are calculated from the forecast abundance and the lower end of the escapement range and used to classify the categorical status of the management units. This rate is the maximum allowed under the {{< glossary PST >}} when the management unit is in the moderate or abundant status, but {{< glossary ERs >}} up to 20 percent are allowed if the management unit is in the low abundance status. The range reflects inherent uncertainty by using the high estimate of recruits-per-spawner and the low estimate of carrying capacity for the lower bound, and the low estimate of recruits-per-spawner and the high estimate of smolt carrying capacity for the upper end of the range.  The ranges were further adjusted upward by 26-184% for risk aversion and habitat considerations. However, annual natural spawning escapement targets may vary from the FMP conservation objectives if agreed to by WDFW and the treaty Indian tribes under the provisions of Hoh versus Baldrige and subsequent US District Court orders. After an annual agreement is reached, ocean fishery escapement objectives are established for each river, or region of origin. The agreement includes provisions for treaty Indian allocation requirements and inside non-Indian fishery needs.  Agreements on annual spawning targets for Washington coastal Coho other than those in the FMP are not made every year (PFMC 2013b).
