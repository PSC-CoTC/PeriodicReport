...
```{r}
#| fig-cap: Pre- and post-season command files and base period used in FRAM to evaluate {{< glossary ERs >}} {{< glossary MUs >}} over catch years 2004 through 2023. "Post-season Original" command files are those used to generate estimates for the Annual {{< glossary ER >}} Report provided to the Southern Panel during the PSC Annual Meeting.
#| label: tab-commands
static$run_files |> 
...
<!-- : Pre- and post-season command files and base period used in FRAM to evaluate {{< glossary ERs >}} {{< glossary MUs >}} over catch years 2004 through 2023. "Post-season Original" command files are those used to generate estimates for the Annual {{< glossary ER >}} Report provided to the Southern Panel during the PSC Annual Meeting. {#tab-commands} -->
...
This {{< glossary MU >}} description was prepared by Canadian members of the PSC Coho Technical Committee.
...
The IFR Coho {{< glossary MU >}} is managed by CDFO and contains five natural (wild) populations (or CUs), each with 1-3 subpopulations as described by the Interior Fraser Coho Recovery Team (IFCRT 2006). Hatchery production is auxiliary to the management unit but integral to the management unit objectives. 
...
###### Fishery Monitoring
Under the PST, DFO is required to annually monitor fishery impacts to all Coho {{< glossary MUs >}} to determine retained catch, {{< glossary CWT >}} recovery rates, and incidental mortalities. Defining {{< glossary MU >}}-specific fishery impacts allows Resource Managers to accurately evaluate {{< glossary ER >}} relative to PST prescribed limits.
...
### Skagit
This {{< glossary MU >}} description was prepared by U.S. members of the PSC Coho Technical Committee.
...
**Current Skagit {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by PSC and {{< glossary Council >}} status categories.**
...
**Current Snohomish {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by PSC and {{< glossary Council >}} status categories.**
...
**Current Hood Canal {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by PSC and {{< glossary Council >}} status categories.**
...
Once a preseason forecast of ocean age-3 adult Coho has been made, the forecast abundance is assessed relative to the prescribe abundance breakpoints; from these breakpoints, the status is assigned. For the Hood Canal {{< glossary MU >}}, forecast abundances at or below 19,545 have “low” (PSC) or “critical" ({{< glossary Council >}}) status, those between 19,545 and 41,000 are “moderate” (PSC) or “low” ({{< glossary Council >}}) status, and those above 41,000 are “abundant” (PSC) or “normal” ({{< glossary Council >}}) status [@PFMC_1_2013].
...
In 2009, the {{< glossary Council >}} adopted annual management objectives for Puget Sound Coho as recommended by WDFW and tribal co-managers under provisions of US versus Washington.  The annual objectives were based on the PSC categorical status and associated maximum {{< glossary ER >}} limits.  The {{< glossary Council >}} formally adopted {{< glossary ER >}} management objectives for Puget Sound Coho in November 2009, which were consistent with PSC objectives, and in 2010 it replaced the longstanding FMP spawning escapement objectives. The current PST/{{< glossary Council >}} {{< glossary ER >}} reference points for the Strait of Juan de Fuca {{< glossary MU >}} natural Coho population are provided below.

**Current US Strait JDF {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ER >}} by PSC and {{< glossary Council >}} status categories.**
...
**Current Quillayute {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by PSC and {{< glossary Council >}} status categories.**
...
**Current Hoh {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by PSC and {{< glossary Council >}} status categories.**
...
**Queets {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by PSC and {{< glossary Council >}} status categories.**
...
**Current Grays Harbor {{< glossary MU >}} ocean abundance reference breakpoints and maximum total {{< glossary ERs >}} by PSC and {{< glossary Council >}} status categories.**
