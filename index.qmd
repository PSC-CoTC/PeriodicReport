...
It is important to note that designation under the WSP is different from that under the {{< glossary PST >}}. Within the {{< glossary PST >}} chapter 5, two of the five stated objectives of the Coho Management program, which guides the establishment of {{< glossary ER >}} ergo {{< glossary PST >}} status, are to a) constrain total {{< glossary ER >}} to maintain maximum sustainable harvest over the long term while maintaining genetic and ecological diversity of the component populations and b) improve long term prospects for healthy fisheries in both countries.
...
{{< glossary PST >}} {{< glossary SCMP >}} constraint is Preliminary. For Puget Sound and Washington Coast management units, the {{< glossary ER >}} constraints reflect application of the 2019 {{< glossary PST >}} {{< glossary SCMP >}}.

Under the {{< glossary PST >}} {{< glossary SCMP >}}, categories (Abundant, Moderate, Low) correspond to the general {{< glossary ER >}} ranges depicted in paragraph 8(b)(iii) of the 2019 {{< glossary PST >}} {{< glossary SCMP >}}. For Washington Coast stocks, categorical status is determined by the {{< glossary ER >}} associated with meeting the escapement goal (or the lower end of the escapement goal range). As Washington Coast stocks are managed to achieve agreed escapement goals, this {{< glossary ER >}} also becomes an approximation of the maximum allowable rate unless the stock is in the "Low" status. In that case, an {{< glossary ER >}} of up to 20% is allowed.
...
*ToDo -  include figure of reoveries in all fisheries and in just pre-terminal fisheries to give the reader a sense of data available to use the MSM to update the base period.  Collin wrote code at the January meeting that makes these figures.  I still need to give him a better mapping file!*
...
**Total exploitation rates by {{< glossary MU >}}, catch years 2011 through 2021.** 
...
*ToDo - summarize the difference between estimated or modelled ERs and what the post-season ER Cap was?  Like we do in the annual ER report, but this would be an MU assessment across the years 2004 to most current catch year. From Denise Hawkins: Yes please.  This would be useful in determining if there is a pattern or consecutive years of exceeding or being way below allowed ERs. Having all of the data in one place would allow better evaluation compared to needing to access the annual ER reports. (2/15/2024)*
...
*ToDo - Create figures (I think you have already done so Collin :) ) and place in an "appendix".  Question for Southern Panel –> do you want this type of figure? If so, what changes, if any, would you like to see? Is there a particular group of years to assess?  We are planning on providing better fishery descriptions than the FRAM code fishery names, ordering the fisheries based on average impacts, and making the graphs bigger.  Would you like for us to pursue looking at impacts from a fishery perspective?  For example, summarizing the catch composition of some of the larger fisheries impacting multiple MU stocks.  From Denise Hawkins: Grouping by MUs would be useful.  Knowing which fisheries impact sensitive stocks would be very helpful. (2/15/2024)*
...
*ToDo - A question for Southern Panel Members --> Would you like to see summaries using forecasted and post-season abundances in addition to abundance categories?  From Denise Hawkins:  That level of granularity of the data may not be needed although interesting to see by how much we were off. (2/15/2024)  LP: This would be helpful.  Possibly include as an appendix due to higher level of granularity? Just an idea.*  
...
In 1999, forecasts for southern BC Coho salmon included {{< glossary IFR >}} Coho for the first time (Holtby et al. 1999). Relative numbers of Coho returning to the North and South Thompson drainages were predicted.  Forecasts for other {{< glossary IFR >}} Coho populations were not made since data quality was sometimes less than adequate. Forecasting for Coho returning to the entire Interior Fraser drainage (recruitment, not escapement) began in 2001 and continues annually (e.g. DFO 2012).  
...
Interior Fraser River Coho spawner assessments have changed over the years based on management priorities and available resources, both in terms of the number of systems surveyed and the extent of coverage. Though {{< glossary IFR >}} spawner estimates exist for a few systems prior to 1975 and the accuracy and precision of those estimates are not understood. Between 1975 and 1997, more effort was expended to estimate {{< glossary IFR >}} escapement in the North and South Thompson CUs. Survey coverage was extended in 1984 to include several key tributaries of the Lower Thompson {{< glossary CU >}}, as well as the Seton and Bridge tributaries of the Middle Fraser {{< glossary CU >}}. Surveys were mainly conducted by Fisheries Officers and hatchery staff; however, the repeatability, and accuracy of these estimates remain poorly understood.
...
For the hatchery indicator stocks the smolt-to-adult survival rate showed a directed downward trend during the early 1990s (brood years) (@fig-IFR_SAR). Data from brood years 1985-1999 shows the smolt-to-adult survival rate averaged 3.7% during this time with a high of 7.2% in 1989. More recently {{< glossary IFR >}} Coho has had an average survival rate of 1.0% between brood years 2000-2017.
...
Currently, there are no {{< glossary ER >}} caps in place for the {{< glossary LWFR >}} {{< glossary MU >}}. Fisheries management measures implemented to protect {{< glossary IFR >}} Coho are assumed to protect the {{< glossary LWFR >}} Coho due to overlap in run timing. In addition, similar marine survival rate patterns between the two {{< glossary MUs >}} provide the support that status-based {{< glossary ER >}} caps for {{< glossary IFR >}} Coho will achieve conservation requirements for {{< glossary LWFR >}} Coho in most years (DFO 2018b). The {{< glossary IFR >}} Coho {{< glossary MU >}} is classified as ‘low’ status under the {{< glossary PST >}} and is currently managed internationally to an overall {{< glossary ER >}} of 20% (10% for Canada and 10% for the U.S.). Canadian domestic management has further reduced the {{< glossary ER >}} objective for {{< glossary IFR >}} Coho to between 3 and 5% annually. The reduction is accomplished through significant restrictions on the retention of naturally produced (adipose fin present) Coho in fisheries where {{< glossary IFR >}} Coho are present, as well as broad-scale closures to fisheries targeting Coho. A moving window closure is implemented annually in the mainstem of the Fraser from September through October to avoid bycatch of {{< glossary IFR >}} Coho (DFO 2020). These restrictions have been in place since 1998, though the 3-5% {{< glossary ER >}} management objective has been in place since 2015. In years prior to 2015, the management objective was occasionally relaxed to facilitate Sockeye targeted fisheries that catch Coho as bycatch (such as in 2014). {{< glossary LWFR >}} Coho are known to have a slightly later run timing than {{< glossary IFR >}} Coho, therefore late-season fisheries occurring after the window closure may still impact the {{< glossary LWFR >}} {{< glossary MU >}}. In the absence of {{< glossary ER >}} caps for this {{< glossary MU >}}, attention should be taken to avoid over-harvesting Coho in late fall fisheries (DFO 2018).
...
Due to management measures implemented to protect {{< glossary IFR >}} Coho, retention of all Coho is limited in all fisheries. Generally, Coho impacts are monitored through programs carried out in non-target fisheries where bycatch is possible. However, some fisheries have been permitted to retain hatchery marked Coho. Nations with access to terminal hatchery systems may have the opportunity to retain adipose fin-clipped (AFC) Coho, such as fish bound for the Inch Creek, the Chilliwack, or the Chehalis hatcheries. Additionally, mark-selective recreational fisheries can be authorized in some areas (Fisheries and Oceans Canada 2020). All fisheries mentioned above are monitored according to the Strategic Framework for Fishery Monitoring and Catch Reporting in Pacific Fisheries (Fisheries and Oceans Canada 2012). 
...
##### Fishery Mortality and Escapement
El Nino events of the early 1990s initiated years of unfavourable marine conditions for Coho. Fish originating from the {{< glossary LWFR >}} may spend their second ocean year either inside the Strait of Georgia or outside. The proximate cause of their varying location has not been explained, although their distribution is correlated with ocean conditions such as salinity. Beginning in 1994, {{< glossary LWFR >}} Coho largely spent their second year outside the Strait of Georgia. This ‘choice’ may have indicated unfavourable conditions within the Strait at that time. Over the long term, urbanization and the destruction of habitat associated with that process also significantly impacted stocks within the {{< glossary LWFR >}} {{< glossary MU >}}. Notwithstanding the loss of habitat, the drastic reductions in escapement have most likely resulted in the underseeding of freshwater habitat in recent years, therefore, further limiting recruitment. High fishery {{< glossary ERs >}} relative to the steadily declining numbers surviving at sea and habitat degradation were the primary factors contributing to the reduction of spawning escapements. Therefore since 1997, Coho fisheries have been severely restricted in order to conserve {{< glossary IFR >}} Coho. These restrictions have resulted in stabilization and improvement of escapement levels, although overall stock abundance remained low. No official stock status has been defined for the {{< glossary LWFR >}} {{< glossary MU >}}, as no reference points have been established.

Catches of Fraser Coho have been extremely low due to long-term restrictions of fisheries implemented to conserve stocks of serious conservation concern, i.e., {{< glossary IFR >}} Coho. Previous to the restrictions, the primary fisheries harvesting {{< glossary LWFR >}} Coho were the West Coast Vancouver Island (WCVI) troll and Georgia Strait sport fisheries (Table 4). The Georgia Strait sport fishery catch declined in 1991 and then again after 1993. This decline resulted from decreased effort in response to a lower abundance of wild fish due to poor marine survival rates. WCVI troll catch declined in 1991 and 1992 but remained high until 1996, just prior to the restriction of Coho retention in this fishery. In 1998 and 1999, the retention of unmarked Coho was prohibited in Canadian waters. Only a few local mark-only fisheries were authorized. The restrictions significantly lowered catch levels and {{< glossary CWT >}} recoveries were primarily from Washington and Alaska fisheries.
...
More recently, an emerging technology analyzing genetic stock identification (GSI) in the form of single nucleotide polymorphisms loci (SNPs) combined with PBT (percentage-based tagging) has provided accurate estimates of stock composition of Coho in salmon mixed-stock fisheries. Catch samples are compared to a baseline composed of 57,982 individuals of Coho salmon ranging from Russia, the United States, and Canada (Beacham et al. 2020). From the 2020 research, it is demonstrated that the individuals from the {{< glossary LWFR >}} CUs were caught in six of the eight mixed-stock fisheries analyzed throughout BC. Specifically, the Nicomen Slough sport fishery was composed almost entirely of {{< glossary LWFR >}} Coho with the exception of one individual from WCVI, indicating incidence of stays. The {{< glossary LWFR >}} CUs were not detected in the Stikine commercial and test fishery and the Barkley Sound sport samples (Beacham et al. 2020). In all other fisheries, species composition indicated low levels of  {{< glossary LWFR >}} Coho catch. Additional information from the {{< glossary CWTs >}} collected confirmed the ability of the baseline to provide reliable estimates of {{< glossary CU >}} composition in the mixed stock fisheries. 
...
*Harvest* 
Fisheries targeting Fraser Coho are limited due to highly restrictive management measures first implemented in 1997 to protect {{< glossary IFR >}} Coho. These fisheries restrictions are known to provide some protection to {{< glossary LWFR >}} Coho as well. However, due to slight differences in run timing between the two {{< glossary MUs >}}, {{< glossary LWFR >}} Coho may be impacted in late season fisheries in some years (DFO 2018) when the {{< glossary IFR >}} Coho window closure has concluded. The majority of {{< glossary LWFR >}} Coho fishery mortalities occurring are incidental catches or through catch in mark-selective fisheries. 
...
```
*question for Collin - move these tables to "static table" and pull?*  Reviewers want this in an Appendix (There is a tab in excel file that contains DIT info for all MUs called "DIT_Codes"  I just added BY 2022 releases to it.
...
Marine survival rates of wild Coho stocks have been estimated using wild {{< glossary CWT >}} indicator stocks in four geographic regions of Puget Sound: Big Beef Creek (within the Hood Canal MU); Deschutes River; South Fork Skykomish River; and Baker River (within the Skagit MU) [@Zimmerman_2012]. These populations are assumed to be representative of the different Puget Sound regions. In the Baker River, a tributary to the Skagit River, marine survival of Coho smolts has averaged 7.8% (range of 1.1% and 13.9%) over 29 brood years (1989–1997, 2000–2020), with a high of 13.9% for brood year 1987 and a low of 1.1% for brood year 2003. High survival (>11.5%) for brood years 2020 through 2022 is encouraging.

ToDo: create this image from the excel file:
...
This information is available in the {{< glossary Council >}}'s 2024 Preseason Report 1 [@PFMC_1_2024] and [@Litz_2024]. 
...
All wild Coho that originate from the Snohomish basin constitute a single {{< glossary MU >}} and are managed as a single stock.  Snohomish River Coho Salmon belong to the larger Puget Sound/Strait of Georgia Coho Salmon evolutionarily significant unit (ESU; Weitkamp et al. 1995).  This ESU is currently a species of concern under the US Endangered Species Act (NOAA Fisheries 2009).

#### Management Framework
##### Management Objectives
Under the Comprehensive Coho Management Plan (CCW 1998), Snohomish River wild Coho is the primary (key) {{< glossary MU >}} and hatchery production is an auxiliary {{< glossary MU >}} (CCW 1998).  Under this plan, primary {{< glossary MUs >}} are controlling units in the sense that predefined management actions that will be undertaken under specified abundance conditions, auxiliary {{< glossary MUs >}} are those managed to meet or exceed a minimum escapement, and secondary units are passively managed in mixed stock fisheries.  Therefore, Snohomish River Coho are managed for natural (wild) production.  

Snohomish Coho Salmon are a primary {{< glossary MU >}} for Puget Sound under the {{< glossary Council >}} (PFMC 2011).  Other primary {{< glossary MUs >}} in this region are eastern Strait of Juan de Fuca, Hood Canal, Skagit, Stillaguamish, and South Puget Sound (hatchery) Coho (PFMC 2011).  The {{< glossary Council >}}’s conservation objectives for these {{< glossary MUs >}} are based on the Puget Sound Salmon Management Plan, which includes management objectives and long-term goals for these stocks as developed by representatives from federal, state, and tribal agencies. 
...
The current {{< glossary PST >}}/{{< glossary Council >}} {{< glossary ER >}} ceilings for the Snohomish {{< glossary MU >}} natural Coho population are provided here:
...
##### Stock Assessment
Since 1996, WDFW and tribal biologists have developed forecasts of wild Coho run size for all primary and most secondary {{< glossary MUs >}} in Puget Sound and the Washington coast (Seiler 1996, Zimmerman 2011).  These annual forecasts are described in the {{< glossary Council >}}’s Preseason Forecast I document each February (PFMC 2012; www.pcouncil.org).  These forecasts rely on estimates of wild Coho production (i.e., smolts) paired with estimates of marine survival.  Wild Coho production estimates for each of the primary and secondary {{< glossary MUs >}} in Puget Sound were derived from results of juvenile trapping studies conducted in the Skagit, Stillaguamish, Snohomish, Green, Nisqually, and Deschutes rivers as well as in tributaries to Lake Washington and Hood Canal.  Analysis of these long-term data sets have demonstrated that wild Coho smolt production is limited by a combination of factors including seeding levels (i.e., escapement), environmental effects (flows, marine derived nutrients), and habitat degradation (Zimmerman 2012). 
...
This forecast includes both Eastern and Western Strait of Juan de Fuca drainages. {{< glossary JA3 >}} ocean recruits were predicted as the product of the estimated 2023 coho smolt outmigration from all independent
tributaries of the Strait of Juan de Fuca, and a predicted marine survival rate  of 7.15 percent. The marine survival rate was predicted by an r-square-weighted average of two linear regression models using the southern
copepod biomass anomaly and the Pacific decadal oscillation index (PDO) from May through September, both during the year of smolt outmigration. The linear relationships that these models solved for have r-square values of 0.34 and 0.33, respectively.
...
This forecast is based on Coho smolt data measured in the Quillayute watershed in 2023 by West Fork Environmental and the Quileute Nation. A total of 252,000 Coho smolts are estimated to have emigrated from the Quillayute River system in 2023. Smolt abundance from the Dickey River was estimated to be 27,431 wild Coho smolts (245 smolts per square mile). Smolt abundance from the Bogachiel, Calawah, and Sol Duc rivers combined was estimated to be 164,701 wild Coho smolts (316 smolts per square mile). Total smolts were separated into summer and fall natural Coho smolts by the relative number of natural brood year 2021 spawners, 3.69% and 96.31%, respectively. Results from this separation yield estimates of 9,300 natural summer coho smolts and 242,700 natural fall Coho smolts. The natural Coho forecast is based on the estimated total natural summer and fall Coho smolt production (252,000) and a {{< glossary JA3 >}} projected marine survival rate of 5.2%.
...
This forecast is based on estimated average natural smolt production per square mile of watershed from the Clearwater River tributary which lies between the Queets River mainstem and the Hoh River. The Quinault Fisheries Department has a long-standing trapping program on the Clearwater River to estimate smolt production; it is assumed the two rivers produce smolts at a comparable rate per square mile of watershed. In 2023, the Clearwater produced 51,620 smolts at the rate of 369 smolts per mile. Applying that rate to the Hoh watershed of 299 square miles yields 110,331 natural Coho smolts emigrating from the Hoh River in 2023.

A marine survival estimate to {{< glossary JA3 >}} of 5.44% was applied to the total natural smolt production estimate to predict the 2024 return of Hoh River natural Coho. This rate is the mean of two marine survival estimates of wild stocks that are to the north and south of the Hoh River: the Queets wild Coho to the south with a marine survival estimate of 7.69% {{< glossary JA3 >}} and Washington Coast wild Coho stocks with
a marine survival estimate of 3.20% {{< glossary JA3 >}}. The average marine survival rate of 5.44% {{<glossary JA3}} (4.41% {{< glossary OA3>}}) is within 2% of the {{< glossary OA3} survival of 3.2% predicted in 2024
for other Washington Coast Coho stocks [@Litz_2024].
...
The current {{< glossary PST >}} total {{< glossary ER >}} ceiling for the natural Coho Salmon population is defined as the maximum rate that will meet the minimum escapement goal of 5,800 when applied to the pre-season ocean abundance forecast (Haymes 2008). The basin is currently managed in US fisheries for a natural fall Coho escapement goal range of 5,800 to 14,500, and annual egg take objectives at the Salmon River Hatchery. The current {{< glossary PST >}} {{< glossary ER >}} ceilings for the Queets {{< glossary MU >}} Coho Salmon population are listed below.

Queets River natural Coho, Strait of Juan de Fuca natural Coho Salmon, and Snohomish River natural Coho Salmon were found to meet the criteria for being classified as overfished in the PFMC Review of 2017 Ocean Salmon Fisheries, released in February 2018. Queets River natural Coho Salmon continue to meet the criteria for overfished status [@PFMC_3_2023]. The harvest control rule during the rebuilding period for Queets Coho is the abundance-based stepped harvest rate of: 
...
The current {{< glossary PST >}} total {{< glossary ER >}} ceiling for the Grays Harbor natural Coho population is defined as the maximum rate that will meet a 35,400 escapement goal when applied to the pre-season ocean abundance forecast (Haymes 2008).  The basin is currently managed in US fisheries for an escapement goal of 35,400. The current {{< glossary PST >}} {{< glossary ER >}} ceilings for the Grays Harbor {{< glossary MU >}} Coho population are listed below.
...
The natural forecast is the sum of the Chehalis River natural, Humptulips River natural, and South Bay
tributary natural forecasts. An OA3 coho marine survival prediction was developed by dividing the
Quinault Department of Fisheries prediction of Queets coho JA3 marine survival by the natural mortality
rate of 1.23169. The Chehalis wild coho smolt production estimate was developed by scaling the 2023
Queets River natural coho smolt production to the Chehalis River production based on the relationship
between the Backward FRAM (BKFRAM) OA3 ocean abundances of Queets and Chehalis natural coho
abundances during the past 15 years. The Humptulips and South Bay tributary forecasts are based on recruit
densities scaled from Clearwater and Chehalis basins, respectively. 

OFL
The OFL is defined in terms of spawner escapement (SOFL). Potential Grays Harbor coho natural area
spawner abundance was derived by adding the current forecast of natural origin coho OA3 abundance,
74,851, to the predicted abundance of OA3 hatchery origin coho spawning in natural areas. The forecast
of OA3 naturally spawning hatchery origin coho is 7,025 and was calculated by multiplying the OA3
hatchery coho abundance forecast, 68,200, by the most recent 5-year average stray rate (2018-2022 average
= 0.103). Annual stray rates were estimated by dividing the number of hatchery origin spawners in natural
areas by the total hatchery origin escapement. For Grays Harbor natural coho MFMT = 0.65 and the OFL
is SOFL = 81,876 × (1-0.65) = 28,657. The preseason SOFL will also be recalculated with postseason
abundance estimates (when available) to assess OFL compliance.
