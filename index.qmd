...
This forecast includes both Eastern and Western Strait of Juan de Fuca drainages. {{< glossary JA3 >}} ocean recruits were predicted as the product of the estimated 2023 Coho Salmon smolt outmigration from all independent tributaries of the Strait of Juan de Fuca, and a predicted marine survival rate  of 7.15 percent. The marine survival rate was predicted by an r-square-weighted average of two linear regression models using the southern copepod biomass anomaly and the Pacific decadal oscillation index (PDO) from May through September, both during the year of smolt outmigration. The linear relationships that these models solved for have r-square values of 0.34 and 0.33, respectively.
