...
```
*question for Collin - move these tables to "static table" and pull?*  Reviewers want this in an Appendix (I moved a copy into the static table file and called it Skagit_DIT
