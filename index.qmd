...
ADD Figure X. Pacific Salmon Treaty Coho MU boundaries in Canada. Note: The Georgia Basin West MU has since been renamed Strait of Georgia Vancouver Island (SGVI) and Georgia Basin East is now Strait of Georgia Mainland (SGML).
...
ADD Figure (example "IFR_Escapement").  Escapement of Interior Fraser River Coho by quality of assessment type.
...
ADD figure  (example IFR_SAR).  Smolt-to-adult survival rate index from coded-wire-tagged (CWT) Interior Fraser River hatchery Coho smolt releases by brood year. Note that insufficient adipose-fin-clipped CWT smolt releases existed prior 1985 and from brood year 1987 to calculate survival; infilled values are the average of the survival up to and including brood year 1991.
...
ADD figure of hatchery production (see "IFR_Enhancement). Total hatchery smolt (A) and fry (B) releases for the Interior Fraser River MU, brood years 1980–2018 (data downloaded on 2021/02/12 from RMIS). Note that the range of the Y-axis is different between panels A and B.
...
ADD Figure (example "IFR_Forecasts" picture). Forecasted and estimated abundances of Interior Fraser River Coho as well as absolute percent error of the yearly forecast.
...
ADD Figure ("IFR_ER1" and IFR_ER2".  Average exploitation rates by fishing area of Interior Fraser River Coho.  The stacked bars represent the rates estimated by gear type during the FRAM base period, catch years 1986–1992 (Top Panel). Bottom panel is the average 1998-2013 catch by gear type.
...
ADD Figure "LWFR_MU_Map". Lower Fraser Coho Management Unit
...
ADD Figure "LWFR_SR". Inch Creek Coho indicator stock smolt to adult survival estimates in the LWFR Coho Management Unit, 1986 to 2017 brood years.
